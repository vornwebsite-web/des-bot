...
const BRAWLERS = {
  ...
  'rico': { name: 'Rico', rarity: 'Super Rare', gadget: 'Trick Shot', star: 'Super Bouncy', gears: 'Damage, Speed', build: 'Ricochet' },
  'crow': { name: 'Crow', rarity: 'Legendary', gadget: 'Swoop', star: 'Extra Toxic', gears: 'Damage, Speed', build: 'Poison Assassin' },
  'bo': { name: 'Bo', rarity: 'Super Rare', gadget: 'Tripwire', star: 'Snare A Bear', gears: 'Control, Damage', build: 'Zoning' },
  ...
  'brock': { name: 'Brock', rarity: 'Rare', gadget: 'Rocket Laces', star: 'Incendiary', gears: 'Damage, Speed', build: 'Artillery' },
  ...
  'dynamike': { name: 'Dynamike', rarity: 'Super Rare', gadget: 'Fidget Spinner', star: 'Demolition', gears: 'Damage, Control', build: 'Explosive' },
  ...
  'penny': { name: 'Penny', rarity: 'Super Rare', gadget: 'Balls of Fire', star: 'Cannon Support', gears: 'Damage, Control', build: 'Cannon' },
  ...
  'gale': { name: 'Gale', rarity: 'Mythic', gadget: 'Spring Ejector', star: 'Twister', gears: 'Control, Speed', build: 'Pushback' },
  ...
  'maisie': { name: 'Maisie', rarity: 'Epic', gadget: 'Rocket Fuel', star: 'Trick or Treat', gears: 'Damage, Control', build: 'Dynamite' },
  'hank': { name: 'Hank', rarity: 'Epic', gadget: 'Rocket Fuel', star: 'Extra Durable', gears: 'Health, Damage', build: 'Anchor Tank' },
  'meg': { name: 'Meg', rarity: 'Mythic', gadget: 'Mega Cableway', star: 'Power Surge Mk. 2', gears: 'Damage, Speed', build: 'Mech Burst' },
  ...
  'squeak': { name: 'Squeak', rarity: 'Rare', gadget: 'Explode', star: 'Sticky Explode', gears: 'Damage, Control', build: 'Explosive' },
  'grom': { name: 'Grom', rarity: 'Epic', gadget: 'Air Accessory', star: 'Big Caliber', gears: 'Damage, Control', build: 'Splash' },
  'janet': { name: 'Janet', rarity: 'Mythic', gadget: 'Drop the Bass', star: 'Vocal Warm-up', gears: 'Damage, Speed', build: 'Flight Zone' },
  ...
  'keeshas': { name: 'Keeshas', rarity: 'Epic', gadget: 'Porterhouse', star: 'Healing Retreat', gears: 'Health, Healing', build: 'Tanky Support' },
  ...
  'piper': { name: 'Piper', rarity: 'Super Rare', gadget: 'Ambush', star: 'Snipe a Lot', gears: 'Damage, Speed', build: 'Long Range' },
  ...
  'el-primo': { name: 'El Primo', rarity: 'Rare', gadget: 'Meteor Rush', star: 'Meteor Crush', gears: 'Health, Damage', build: 'Heavyweight' },
  ...
  'cordelius': { name: 'Cordelius', rarity: 'Mythic', gadget: 'Bloodlust', star: 'Regeneration', gears: 'Damage, Health', build: 'Vampire Damage' },
...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await interaction.editReply({ embeds: [E.gold(`${brawler.name} - BEST BUILD`, `${brawler.rarity}`, [
      { name: '🎯 Build', value: brawler.build, inline: false },
