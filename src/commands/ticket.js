...
return roles.some(function(r) { return member.roles.cache.has(r); });
}

module.exports = {
data: new SlashCommandBuilder()
.setName(“ticket”).setDescription(“Ticket support system”)
.addSubcommand(function(s) { return s.setName(“setup”).setDescription(“Configure the ticket system”)
.addRoleOption(function(o) { return o.setName(“support-role-1”).setDescription(“Support staff role 1”).setRequired(true); })
.addRoleOption(function(o) { return o.setName(“support-role-2”).setDescription(“Support staff role 2”); })
.addRoleOption(function(o) { return o.setName(“support-role-3”).setDescription(“Support staff role 3”); })
.addRoleOption(function(o) { return o.setName(“support-role-4”).setDescription(“Support staff role 4”); })
.addRoleOption(function(o) { return o.setName(“support-role-5”).setDescription(“Support staff role 5”); })
.addChannelOption(function(o) { return o.setName(“log-channel”).setDescription(“Channel for ticket logs”); })
.addChannelOption(function(o) { return o.setName(“category”).setDescription(“Category for ticket channels”); })
.addIntegerOption(function(o) { return o.setName(“max-open”).setDescription(“Max open tickets per user”).setMinValue(1).setMaxValue(5); });
})
.addSubcommand(function(s) { return s.setName(“addrole”).setDescription(“Add a support role”)
.addRoleOption(function(o) { return o.setName(“role”).setDescription(“Role to add”).setRequired(true); });
})
.addSubcommand(function(s) { return s.setName(“removerole”).setDescription(“Remove a support role”)
.addRoleOption(function(o) { return o.setName(“role”).setDescription(“Role to remove”).setRequired(true); });
})
.addSubcommand(function(s) { return s.setName(“roles”).setDescription(“View all support roles”); })
.addSubcommand(function(s) { return s.setName(“panel”).setDescription(“Post the ticket panel in this channel”); })
.addSubcommand(function(s) { return s.setName(“create”).setDescription(“Open a support ticket”)
.addStringOption(function(o) { return o.setName(“subject”).setDescription(“Ticket subject”).setRequired(true); })
.addStringOption(function(o) { return o.setName(“type”).setDescription(“Ticket type”).addChoices(
...
.addSubcommand(function(s) { return s.setName(“close”).setDescription(“Close this ticket”)
.addStringOption(function(o) { return o.setName(“reason”).setDescription(“Reason for closing”); });
})
.addSubcommand(function(s) { return s.setName(“claim”).setDescription(“Claim this ticket”); })
.addSubcommand(function(s) { return s.setName(“unclaim”).setDescription(“Unclaim this ticket”); })
.addSubcommand(function(s) { return s.setName(“add”).setDescription(“Add a user to this ticket”)
.addUserOption(function(o) { return o.setName(“user”).setDescription(“User to add”).setRequired(true); });
})
.addSubcommand(function(s) { return s.setName(“remove”).setDescription(“Remove a user from this ticket”)
.addUserOption(function(o) { return o.setName(“user”).setDescription(“User to remove”).setRequired(true); });
})
.addSubcommand(function(s) { return s.setName(“rename”).setDescription(“Rename this ticket channel”)
.addStringOption(function(o) { return o.setName(“name”).setDescription(“New channel name”).setRequired(true); });
})
.addSubcommand(function(s) { return s.setName(“priority”).setDescription(“Set ticket priority”)
.addStringOption(function(o) { return o.setName(“level”).setDescription(“Priority level”).setRequired(true).addChoices(
{ name: “Low”, value: “low” },
...
.addSubcommand(function(s) { return s.setName(“transcript”).setDescription(“Save a transcript of this ticket”); })
.addSubcommand(function(s) { return s.setName(“list”).setDescription(“List all open tickets”); })
.addSubcommand(function(s) { return s.setName(“info”).setDescription(“View info about this ticket”); }),
...
if (sub === "setup") {
  ...
  const supportRoles = [1,2,3,4,5]
    .map(function(n) { const r = interaction.options.getRole("support-role-" + n); return r ? r.id : null; })
    .filter(Boolean);
  ...
  const roleList = uniqueRoles.map(function(r) { return "<@&" + r + ">"; }).join("\n") || "None";
  ...
  const updated = current.filter(function(r) { return r !== role.id; });
  ...
  const fields = roles.map(function(r, i) { return { name: "Role #" + (i+1), value: "<@&" + r + ">", inline: true }; });
  ...
  if (existing.length >= maxOpen) {
    const links = existing.map(function(t) { return "<#" + t.channelId + ">"; }).join(", ");
  ...
  const pingParts = ["<@" + interaction.user.id + ">"].concat(supportRoles.map(function(r) { return "<@&" + r + ">"; }));
  ...
  if (logChannelId) {
    try {
      ...
      const text = sorted.map(function(m) { return "[" + new Date(m.createdTimestamp).toISOString() + "] " + m.author.tag + ": " + (m.content || "[Embed/Attachment]"); }).join("\n");
      const att = new AttachmentBuilder(Buffer.from(text, "utf-8"), { name: "transcript-" + t.ticketId + ".txt" });
      const logCh = await client.channels.fetch(logChannelId).catch(function() { return null; });
      if (logCh) {
        await logCh.send({
  ...
  const body = sorted.map(function(m) { return "[" + new Date(m.createdTimestamp).toISOString() + "] " + m.author.tag + ": " + (m.content || "[Embed/Attachment]"); }).join("\n");
  ...
  const fields = tickets.slice(0, 10).map(function(t) {
    return {
